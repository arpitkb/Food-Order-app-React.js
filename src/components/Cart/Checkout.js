        ...
        <div className="row justify-content-end">
          <div className="col-6">
            <div className={`${classes.control}`}>
              ...
              ></input>
              {isFNameInvalid && (
                <p className={classes.invalid}>First Name is required!</p>
              )}
            </div>
          </div>
          <div className="col-6">
            <div className={classes.control}>
              ...
              <input
                ...
                type="text"
              ></input>
              {/* {isLNameInvalid && <p className={classes.invalid}>Last Name is required</p>} */}
            </div>
          </div>
        </div>
        ...
        <div className="row row justify-content-evenly">
          ...
          <div className="col-6 mb-5 mt-5">
            <div className={classes.actions}>
              <button onClick={props.cancelOrder} type="button">
                Cancel Order
              </button>
